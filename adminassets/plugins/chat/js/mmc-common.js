...
$(document).on('click', '#main-chat #paper-btn', function (e) {
        ...
        _box_message.append('<div class="message out no-avatar  media m-b-20">' +
            ...
            ' <div class="sender media-right friend-box"><a href="javascript:void(0);" title="Me"><img src="../files/images/avatar-1.png" class="rounded-circle img-chat-profile" alt="Me"></a> </div>' +
            '</div>');
