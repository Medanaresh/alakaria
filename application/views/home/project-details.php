...
<div class="container">
	...
	<div class="col-md-12 p-0">
		...
		<div class="overview_tabs">
		 ...
		 <ul class="nav nav-tabs owl-carousel owl-theme projectdet_carousel">
		     
		     
<?php if(!empty($projectbanners)) { ?>
			  <li class="nav-item aos-init aos-animate item" data-aos="fade-up" data-aos-duration="400">

				<a class="nav-link text-uppercase" onclick="this.style.color='#B39079'" href="#Overview">
<?php if($lang == "en") { echo "Project Overview"; } else { echo "نبذة عن المشروع"; } ?>
				</a>
...
<?php if(!empty($projectresources)) { ?>
			  <li class="nav-item aos-init aos-animate item" data-aos="fade-up" data-aos-duration="500">
				...
				<a class="nav-link text-uppercase" onclick="this.style.color='#B39079'" href="#Resources">
				
<?php if($lang == "en") { echo "Project Resources"; } else { echo "موارد المشروع"; } ?>
				</a>

			  </li>
<?php } ?>

<?php if(!empty($paymentplan)) { ?>
			  <li class="nav-item aos-init aos-animate item" data-aos="fade-up" data-aos-duration="600">

				<a class="nav-link text-uppercase" onclick="this.style.color='#B39079'" href="#Payment">
				
<?php if($lang == "en") { echo "Payment Plan"; } else { echo "خطط التسديد"; } ?>
				</a>
	...
	<?php } ?>		  
			  ...
			  <?php if(!empty($facilityfeatures)) { ?>

			  <li class="nav-item aos-init aos-animate item" data-aos="fade-up" data-aos-duration="700">

				<a class="nav-link text-uppercase" onclick="this.style.color='#B39079'"  href="#Features">
				
<?php if($lang == "en") { echo "Features"; } else { echo "المميزات"; } ?>
				</a>

			  </li>
			  <?php } ?>

			  <li class="nav-item aos-init aos-animate item" data-aos="fade-up" data-aos-duration="800">

				<!--<a class="nav-link text-uppercase" data-toggle="tab" href="#Interest">Register Your Interest</a>-->

<a class="nav-link text-uppercase" onclick="this.style.color='#B39079'" href="#Interest">

<?php if($lang == "en") { echo "Register Your Interest"; } else { echo "سجل اهتمامك"; } ?>
</a>
...
<?php foreach($brochure as $key=>$val) { ?>
				 <div class="broucher_design" id="Resources">
...
<a href="<?php echo base_url().$val->pdf; ?>" download>
				<button type="button" class="btn btn-primary btn-lg text-uppercase btn-white" ><?php if($lang == "en") { echo "Download"; } else { echo "تحميل"; } ?> </button>
</a>
				</div>
...
<?php if(!empty($projectimages)) { ?>
				  <div class="overview_project_images">
				      ...
				      <h4 class="text-uppercase text-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="1500"><?php if($lang == "en") { echo "Project Images"; } else { echo "صور المشروع"; } ?></h4>
...
<div id="outlet_map" style="height:400px;width: 100%"></div>
				  ...
				  <?php if(!empty($paymentplan)) { ?>
				  <div class="payment_plan aos-init aos-animate" data-aos="fade-up" data-aos-duration="1900" id="Payment">
...
<?php if($lang == "en") { echo $val->subtitle_en; } else { echo $val->subtitle_ar; } ?>
					  ...
					  <div class="plans_list mt-4 main-li">
...
<?php if(!empty($facilityfeatures)) { ?>
				  <div class="facility_features" id="Features">

				  <div class="inner_features">

					  <div class="heading_div text-center">

	<h4 class="inner_heading text-uppercase text-center text-white aos-init aos-animate" data-aos="fade-up" data-aos-duration="2900"><?php if($lang == "en") { echo "facility Features"; } else { echo "المميزات"; } ?></h4>
...
<h4 class="text-uppercase text-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="3000">
 <?php if($lang=="en") { echo "Register Your Interest"; } else { echo "سجل اهتمامك"; } ?>
</h4>
...
<input type="hidden" value="<?php echo $project_id; ?>" name="project_id">
						 <div class="form-group w_50 pl-0 pr-2 aos-init aos-animate" data-aos="fade-up" data-aos-duration="3000">
						  ...
						  <label class="form_label"><?php if($lang == "en") { echo "First Name"; }else { echo "الاسم الاول"; } ?></label>
						  ...
						  <label class="form_label"><?php if($lang == "en") { echo "Last Name"; }else { echo "الاسم الأخير"; } ?></label>
						  ...
						  <label class="form_label"><?php if($lang == "en") { echo "Country"; } else { echo "الدولة"; } ?></label>
						  ...
						  <label class="form_label"><?php if($lang == "en") { echo "Phone Number"; } else { echo "رقم الجوال"; } ?></label>
							...
							<input type="text" name="data[mobile]" class="form-control"  placeholder="<?php if($lang == "en") { echo "Phone Number"; } else { echo "رقم الجوال"; } ?>" />
						  ...
						  <label class="form_label"><?php if($lang == "en") { echo "Email"; } else { echo "البريد الإلكتروني"; }?></label>
...
<!--<input type="submit" class="btn btn-primary btn-lg text-uppercase btn-brown mx-auto d-block" value="<?php if($lang == "en") { echo "Register Now";} else { echo "سجل الان"; } ?>">-->
<button type="button" class="btn btn-primary btn-xl text-uppercase btn-brown insert_banners" ><?php if($lang == "en") { echo "Register Now";} else { echo "سجل الان"; } ?></button>
        ...
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){                
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>home/saveprjectrequests",
