...
<section class="projects_section home_projects">
	        ...
	        <div class="main_heading">
	          ...
	          <h2 class="text-uppercase side_heading text-center aos-init aos-animate" data-aos="fade-up" data-aos-duration="400"><?php if($lang == "en") { echo "Projects"; } else { echo "المشاريع"; }?></h  
...
<!--<li class="nav-item aos-init aos-animate" data-aos="fade-up" data-aos-duration="400">
				...
				<a class="nav-link active" data-toggle="tab" href="#project2">RETAIL & COMMERCIAL</a>
...
<li class="nav-item aos-init aos-animate" data-aos="fade-up" data-aos-duration="400">
				...
				<a class="nav-link" data-toggle="tab" href="#project3">RESIDENTIAL</a>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">

			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_THE PLAZA.jpg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Plaza</a></h6>

				<!--<p><p>On Olaya Street, the commercial center of Riyadh, the first smart building in the Kingdom of Saud</p>-->
<p><p>On Olaya Street, the commercial center of Riyadh, the first smart building in the Kingdom of Saud</p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_DSC00040.JPG" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>

				<!--<p><p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>-->
<p><p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_ALAKARIA1y.jpg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 2</a></h6>

				<!--<p><p>On main streets in the Olaya district, centres with its contemporary design as one of the finest </p>-->
<p><p>On main streets in the Olaya district, centres with its contemporary design as one of the finest </p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_صور-خارجية10-1920x1078.jpeg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 3</a></h6>

				<!--<p><p>In the middle of the second Al Akaria center and the plaza on Olaya Street is the longest commerc</p>-->
<p><p>In the middle of the second Al Akaria center and the plaza on Olaya Street is the longest commerc</p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_DSC00038.JPG" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Al Akaria Sitteen</a></h6>

				<!--<p><p>In Al Malaz, the oldest and most beautiful neighborhood in Riyadh and the closest to government o</p>-->
<p><p>In Al Malaz, the oldest and most beautiful neighborhood in Riyadh and the closest to government o</p>
			</div>
				...
				<button type="button" onclick="location.href='http://162.215.214.56/~alakaria/projects'" class="btn btn-primary btn-md text-uppercase btn-brown mx-auto d-block">Show More </button>
...
<div class="swiper mySwiper">
      <div class="swiper-wrapper">
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_c2.jpg" alt="img" class="property_img" />
		<div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div>
		</div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_Aerial_Cam_Left_Final.jpg" alt="img" class="property_img" />
		<div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div></div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_262A0966.jpg" alt="img" class="property_img" />
		<div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div></div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_c2.jpg" alt="img" class="property_img" /><div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div></div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_Aerial_Cam_Left_Final.jpg" alt="img" class="property_img" /><div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div></div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_262A0966.jpg" alt="img" class="property_img" /><div class="data-on">
			<h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Akaria 1</a></h6>
			<p>In Olaya, the essence of the main locations in Riyadh, the first commercial center in the Middle </p>
		</div></div>
        <div class="swiper-slide"><img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_c2.jpg" alt="img" class="property_img" /><div class="data-on">
	  ...
	  <div class="swiper-button-next"><div>Next Project<span><img src='http://162.215.214.56/~alakaria/images/project_navicon.png' /></span></div></div>
      <div class="swiper-button-prev"><div>Previous Project<span><img src='http://162.215.214.56/~alakaria/images/project_navicon.png' /></span></div></div>
      <div class="swiper-pagination"></div>
    </div>

			<!--<div class="owl-carousel owl-theme projects_carouselNew">
<div class="item">

		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">

			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_c2.jpg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">La Casa Compound</a></h6>

				
<p><p>A residential gated compound strategically set in the northern part of Riyadh, providing serenity</p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_Aerial_Cam_Left_Final.jpg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Al Dhahia</a></h6>

				
<p><p>Al Dhahia&rsquo;s unique quality lies in the idyllic environment in which it is surrounded. The r</p>
			</div>
...
<div class="item">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='http://162.215.214.56/~alakaria/projects'">
			 ...
			 <img src="http://162.215.214.56/~alakaria/adminassets/compressed/c_262A0966.jpg" alt="img" class="property_img" />

		    <div class="data-on">

			    <h6><a href="http://162.215.214.56/~alakaria/projects" class="text-white hover-text- font-400">Olaya Oasis Compound</a></h6>

				
<p><p>Olaya Oasis is a residential oasis with urban lifestyle amenities. One of the first residential c</p>
			</div>
