...
<?php 
//print_r($projecttypes[0]);
//echo $projecttypes[0]->id;
foreach($projecttypes as $value2){?>
...
<div class="swiper-slide">
		 ...
		 <div class="property-grid-3 property-block transation hover-img-zoom rounded mb-30"  onclick="location.href='<?php echo base_url("project-details/$value3->id"); ?>'">
			 ...
			 <img src="<?php echo base_url('').$value3->image; ?>" alt="img" class="property_img" onclick="location.href='<?php echo base_url("project-details/$value3->id"); ?>'"/>

		    <div class="data-on">

			    <h6><a href="<?php echo base_url("project-details/$value3->id"); ?>" class="text-white hover-text- font-400"><?php if($lang == "en") {  echo $value3->title_en; } else { echo $value3->title_ar; }?></a></h6>
...
<?php } ?>
		 ...
		 <div class="swiper-button-next"><div><?php if($lang == "en") { echo "Next Project";} else { echo "المشروع التالي"; } ?><span><img src='http://162.215.214.56/~alakaria/images/project_navicon.png' /></span></div></div>
      <div class="swiper-button-prev"><div><?php if($lang == "en") { echo "Previous Project";} else { echo "المشروع السابق"; }?><span><img src='http://162.215.214.56/~alakaria/images/project_navicon.png' /></span></div></div>
