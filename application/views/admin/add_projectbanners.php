...
<p style="color:red;text-align:right;"> Note: Banner dimension (1577 X 645 pixels)</p>
 ...
 <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">
                ...
                <input type="hidden" name="table" value="projectbanners">
        ...
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){ 
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_projectbanners",
