...
<script type="text/javascript">
  $(document).ready(function () 
  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_contactdetails');?>', {id: id},
      function(){
      $modal.modal('show');
      });
    });
/*     $('.edit_banners').on('click',function(event){
     ...
     //  alert(id);alert(table);
       swal({
          ...
          function(){
            $.ajax({                
             url: "<?php echo base_url();?>admin/delete_contactdetails",
             type: "POST",
             data: {id:id},
