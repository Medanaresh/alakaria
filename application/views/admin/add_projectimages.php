...
<p style="color:red;text-align:right;"> Note: Image dimensions (643 X 451 pixels)</p>
 ...
 <input type="hidden" name="project_id" value="<?php echo $project_id; ?>">
                ...
                <input type="hidden" name="table" value="projectimages">
        ...
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_projectimages",
