                        ...
                        <tbody>
                          ...
                          <?php if(@$value){  
                           ...
                           <tr>
                              ...
                              <td><?php echo $sn++; ?></td>
<!--<td>
<img src="<?php echo base_url('').$bans->image; ?>" height="50px;" width="50px;">
</td>-->
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_privacyPolicy');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_privacyPolicy",
