...
<td><?php echo $bans->mobile; ?></td>
<td><span class="<?php echo $bans->address1; ?>"><?php echo ucfirst($bans->city).", ".ucfirst($bans->state)."-".$bans->zipcode; ?></span></td>
<td><?php
...
<button type="button" class="btn btn-primary waves-effect waves-light view_banners" data-toggle="modal"  data-target = "#add_banners" data-id="<?php echo $bans->id; ?>"  style="float: none;margin: 5px;">
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_contact_request3');?>', {id: id},
...
$('.view_banners').on('click',function(event){

      var id = $(this).data('id');     

      event.stopPropagation();

      $modal.load('<?php echo site_url('admin/view_career_requests');?>', {id: id},
