    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Country Code</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[code]" placeholder="Country Code" value="<?php echo @$value->code?>">						
                    </div>
                ...
                <input type="hidden" name="table" value="countrycodes">
    ...
    //            data.set('data[mission_description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_countrycodes",
