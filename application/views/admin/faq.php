...
//print_r($value);
                           ...
                           <tr>
                              ...
                              <td><?php echo $sn++; ?></td>
<?php if($bans->category_id != '0') { ?>
<td><?php echo $names[$bans->category_id]; ?></td>
<?php } else { ?>
<td>No Category Selected</td>

<?php } ?>
                         <td><?php echo $bans->question_en; ?></td>
 <td><?php echo $bans->answer_ar; ?></td>
...
$("body").on("click", ".add_banners", function(event){ 
      ...
      $modal.load('<?php echo site_url('admin/add_faq');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_faq",
