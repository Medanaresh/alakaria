...
<p style="color:red;text-align:right;"> Note: Banner diemention (1921 X 1074 pixels)</p>
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text" class="form-control" name="data[title]"  required placeholder="" value="<?php echo @$value->title?>" />
