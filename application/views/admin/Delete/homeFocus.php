...
if(@$value)
{
    ...
    {
    if(!empty(@$val->description_en) && !empty(@$val->description_ar) && !empty(@$val->image))
    {
        $validFlag = 1;
    }
    }
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_homeFocus');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_homeFocus",
