                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Name</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[name]" placeholder="Name" value="<?php echo @$value->name?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Designation</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[designation]" placeholder="Designation" value="<?php echo @$value->designation?>">
