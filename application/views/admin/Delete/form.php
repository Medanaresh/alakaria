    ...
    <!-- iconfont -->
    <link rel="stylesheet" type="text/css" href="assets/icon/icofont/css/icofont.css" tppabs="http://ableproadmin.com/light/vertical/assets/icon/icofont/css/icofont.css">

    <!-- simple line icon -->
    <link rel="stylesheet" type="text/css" href="assets/icon/simple-line-icons/css/simple-line-icons.css" tppabs="http://ableproadmin.com/light/vertical/assets/icon/simple-line-icons/css/simple-line-icons.css">

    <!-- Required Fremwork -->
    <link rel="stylesheet" type="text/css" href="assets/css/bootstrap.min.css" tppabs="http://ableproadmin.com/light/vertical/assets/css/bootstrap.min.css">

    <!-- bash syntaxhighlighter css -->
    <link type="text/css" rel="stylesheet" href="assets/plugins/highlighter/css/shCoreDjango.css" tppabs="http://ableproadmin.com/light/vertical/assets/plugins/highlighter/css/shCoreDjango.css"/>

    <!-- Style.css -->
    <link rel="stylesheet" type="text/css" href="assets/css/main.css" tppabs="http://ableproadmin.com/light/vertical/assets/css/main.css">

    <!-- Responsive.css-->
    <link rel="stylesheet" type="text/css" href="assets/css/responsive.css" tppabs="http://ableproadmin.com/light/vertical/assets/css/responsive.css">

    <!--color css-->
   <link rel="stylesheet" type="text/css" href="assets/css/color/color-1.css" tppabs="http://ableproadmin.com/light/vertical/assets/css/color/color-1.css" id="color"/>
        ...
        <div class="container-fluid">
            ...
            <div >
                    ...
                    <div class="col-sm-12 p-0">
                        <div class="main-header">
                            ...
                            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
                                ...
                                <li class="breadcrumb-item"><a href="javascript:if(confirm(%27http://ableproadmin.com/light/vertical/general-elements-bootstrap.html  \n\nThis file was not retrieved by Teleport Ultra, because the server reports that this file cannot be found.  \n\nDo you want to open it from the server?%27))window.location=%27http://ableproadmin.com/light/vertical/general-elements-bootstrap.html%27" tppabs="http://ableproadmin.com/light/vertical/general-elements-bootstrap.html">General Elements</a>
                                </li>
                            </ol>
                        </div>
                    </div>
                            ...
                            <div class="card-block">
                                <form>
                                    ...
                                    <div class="form-group row v-middle">
                                        ...
                                        <div class="col-sm-9">
                                            <p>note : <code>color</code> Attribute 	Not working in safari</p>
                                        </div>
                                    </div>
                                    <div class="form-group row">
                                        <label for="file" class="col-md-2 col-form-label form-control-label">File input</label>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text">Validation with Helper</h5>
                                <div class="f-right">
                                    <a href="" data-toggle="modal" data-target="#validation-helper-Modal"><i class="icofont icofont-code-alt"></i></a>
                                </div>
                            </div>
                            <div class="modal fade modal-flex" id="validation-helper-Modal" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <h5 class="modal-title">Code Explanation for Validation with helper</h5>
                                        </div>
                                        <!-- end of modal-header -->
                                        <div class="modal-body">
			                      <pre class="brush: html;">
                            ...
                            <div class="card-block">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="checkbox-color checkbox-success">
                                        <input id="checkbox2" type="checkbox" checked="checked">
                                        <label for="checkbox2" class="text-success">
                                            Success
                                        </label>
                                    </div>
                                    <div class="checkbox-color checkbox-danger">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text"> Validation</h5>
                                <div class="f-right">
                                    <a href="" data-toggle="modal" data-target="#validation-input-Modal"><i class="icofont icofont-code-alt"></i></a>
                                </div>
                            </div>
                            <div class="modal fade modal-flex" id="validation-input-Modal" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <h5 class="modal-title">Code Explanation for Validation</h5>
                                        </div>
                                        <!-- end of modal-header -->
                                        <div class="modal-body">
                      <pre class="brush: html;">
                            ...
                            <div class="card-block">
                                <div class="form-group row">
                                    <div class="col-md-2 txt-success "><label for="InputSuccess" class="form-control-label">Success</label></div>
                                    <div class="col-md-10"><input type="text" class="form-control input-success" id="InputSuccess"  ></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 txt-warning "><label for="InputWarning" class="form-control-label">Warning</label></div>
                                    <div class="col-md-10"><input type="text" class="form-control input-warning" id="InputWarning" ></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 txt-danger "><label for="InputDanger" class="form-control-label">Danger</label></div>
                                    <div class="col-md-10"><input type="text" class="form-control input-danger" id="InputDanger"  ></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 txt-success "><label class="form-control-label" >Input with success</label></div>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control input-success" id="inputWithSuccess">
                                        <i class="icofont icofont-check input-icon txt-success"></i>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 txt-warning "><label class="form-control-label" >Input with warning</label></div>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control input-warning" id="inputWithWarning">
                                        <i class="icofont icofont-warning input-icon txt-warning"></i>
                                    </div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2 txt-danger "><label class="form-control-label" >Input with Danger</label></div>
                                    <div class="col-md-10">
                                        <input type="text" class="form-control input-danger" id="inputWithDanger">
                                        <i class="fa fa-times input-icon txt-danger"></i>
                                    </div>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2 "><label class="form-control-label">Checkbox</label></div>
                                    <div class="col-md-10 has-success">
                                        <label class="custom-control custom-checkbox">
                                            <input type="checkbox" class="custom-control-input">
                                            <span class="custom-control-indicator"></span>
                                ...
                                <div class="form-group row">
                                    <div class="col-md-2 "><label class="form-control-label">Radio Button</label></div>
                                    <div class="col-md-10 has-danger">
                                        <label class="custom-control custom-radio">
                                            <input id="radio1" name="radio" type="radio" class="custom-control-input">
                                            <span class="custom-control-indicator"></span>
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            ...
                            <div class="card-block">
                                <div class="form-group row">
                                    <label for="InputSmall" class="col-md-2 form-control-label">Small</label>
                                    <div class="col-md-10"><input type="text" class="form-control form-control-sm" id="InputSmall"  placeholder="form-control-sm"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2"><label for="InputNormal" class="form-control-label">Normal</label></div>
                                    <div class="col-md-10"><input type="text" class="form-control" id="InputNormal"  placeholder="Normal"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2"><label for="InputLarge" class="form-control-label col-form-label-lg">Large</label></div>
                                    <div class="col-md-10"><input type="text" class="form-control form-control-lg" id="InputLarge"  placeholder="form-control-lg"></div>
                                </div>
                                <div class="form-group row">
                                    <div class="col-md-2"><label for="InputLarge" class="form-control-label">Grid</label></div>
                                    <div class="col-xs-3">
                                        <input type="text" class="form-control" placeholder=".col-xs-3">
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text">Basic Form</h5>
                                <div class="f-right">
                                    <a href="" data-toggle="modal" data-target="#basic-form-Modal"><i class="icofont icofont-code-alt"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card-block">
                                ...
                                <form>
                                    ...
                                    <button type="submit" class="btn btn-success waves-effect waves-light m-r-30">Sign in</button>
                                </form>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="col-lg-6">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text">Horizontal Form</h5>
                                <div class="f-right">
                                    <a href="" data-toggle="modal" data-target="#horizontal-form-Modal"><i class="icofont icofont-code-alt"></i></a>
                                </div>
                            </div>
                            ...
                            <div class="card-block">
                                ...
                                <p class="m-b-20">
                                    Bootstrap4 dropped the <code>.form-horizontal</code> class requirement.so we not need to add <code>.form-horizontal</code>class
                                    ..form-group no longer applies styles from the <strong>.row</strong> via mixin, so <strong>.row</strong> is now required for horizontal grid layouts
                                </p>
                                ...
                                <form>
                                    ...
                                    <div class="form-group row">
                                        <label for="h-re-pwd" class="col-md-2 col-form-label form-control-label">Confirm Pwd</label>
                                        <div class="col-md-10">
                                            <input id="h-re-pwd" type="password" class="form-control" placeholder="Re Enter Password">
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="checkbox checkbox-primary">
                                            <div class="col-md-10">
                                                <input type="checkbox" id="chkremeberme">
                                                <label for="chkremeberme" class="m-b-10">Remember me</label>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="col-md-9">
                                            <button type="submit" class="btn btn-primary waves-effect waves-light m-r-30">Sign in</button>
                                        </div>
                                    </div>
                                </form>
                            </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12 inline-forms">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text">Inline Form</h5></div>
                            <div class="card-block">
                                <p class="m-b-20">
                                ...
                                <div class="card inline-form-style inline-form-1">
                                    <div class="card-header"><h5 class="card-header-text">Hidden labels</h5>
                                        <div class="f-right">
                                            <a href="" data-toggle="modal" data-target="#hidden-labels-Modal"><i class="icofont icofont-code-alt"></i></a>
                                        </div>
                                    </div>
                                    <div class="modal fade modal-flex" id="hidden-labels-Modal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <h5 class="modal-title">Code Explanation for Hidden Labels</h5>
                                                </div>
                                                <!-- end of modal-header -->
                                                <div class="modal-body">
					                      <pre class="brush: html;">
                                    ...
                                    <div class="card-block"><form class="form-inline">
                                ...
                                <div class="card inline-form-style inline-form-2">
                                    <div class="card-header"><h5 class="card-header-text">Inline labels</h5>
                                        <div class="f-right">
                                            <a href="" data-toggle="modal" data-target="#inline-labels-Modal"><i class="icofont icofont-code-alt"></i></a>
                                        </div>
                                    </div>
                                    <div class="modal fade modal-flex" id="inline-labels-Modal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <h5 class="modal-title">Code Explanation for Inline Labels</h5>
                                                </div>
                                                <!-- end of modal-header -->
                                                <div class="modal-body">
					                      <pre class="brush: html;">
                                    ...
                                    <div class="card-block">
                                        <form class="form-inline">
                                            <div class="form-group m-r-15">
                                                <label for="inline2mail" class="m-r-15 form-control-label">Email address</label>
                                                <input id="inline2mail" type="email" class="form-control"  placeholder="Enter email">
                                            </div>
                                            <div class="form-group m-r-15">
                                                <label for="inline2pwd" class="m-r-15 form-control-label">Password</label>
                                                <input id="inline2pwd" type="password" class="form-control" placeholder="Password">
                                            </div>
                                            <div class="form-check m-r-10">
                                                <label for="inline2chk" class="form-check-label">
                                ...
                                <div class="card inline-form-style">
                                    <div class="card-header"><h5 class="card-header-text">Form groups</h5>
                                        <div class="f-right">
                                            <a href="" data-toggle="modal" data-target="#form-groups-Modal"><i class="icofont icofont-code-alt"></i></a>
                                        </div>
                                    </div>
                                    <div class="modal fade modal-flex" id="form-groups-Modal" tabindex="-1" role="dialog">
                                        <div class="modal-dialog modal-lg" role="document">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                                    ...
                                                    <h5 class="modal-title">Code Explanation for form groups</h5>
                                                </div>
                                                <!-- end of modal-header -->
                                                <div class="modal-body">
					                      <pre class="brush: html;">
                                    ...
                                    <div class="card-block">
                                        <form class="form-inline">
                                            ...
                                            <div class="form-check p-t-35">
                                                <label for="inline3chk" class="form-check-label m-r-10">
                                                    <input id="inline3chk" class="form-check-input" type="checkbox"> Remember me
                                                </label>
                                                <button type="submit" class="btn btn-danger waves-effect waves-light m-r-30">Sign in</button>
                                            </div>
                                        </form>
                                    </div>
                                </div>
                ...
                <div class="row">
                    ...
                    <div class="col-lg-12">
                        <div class="card">
                            <div class="card-header"><h5 class="card-header-text">Input Groups & Addon</h5>
                                <div class="f-right">
                                    <a href="" data-toggle="modal" data-target="#input-addon-Modal"><i class="icofont icofont-code-alt"></i></a>
                                </div>
                            </div>
                            <div class="modal fade modal-flex" id="input-addon-Modal" tabindex="-1" role="dialog">
                                <div class="modal-dialog modal-lg" role="document">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                                            ...
                                            <h5 class="modal-title">Code Explanation for input groups & addons</h5>
                                        </div>
                                        <!-- end of modal-header -->
                                        <div class="modal-body">
			                      <pre class="brush: html;">
                            ...
                            <div class="card-block">
                                ...
                                <form class="row">
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="col-form-label f-w-600" for="alighaddon2">Align</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="alighaddon1">@</span>
                                                    <input type="text" class="form-control" placeholder="Username">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="sr-only" for="alighaddon2">Align addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <input type="number" id="alighaddon2" class="form-control" placeholder="Percentage" aria-describedby="basic-addon2">
                                                    <span class="input-group-addon" id="basic-addon2">%</span>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="sr-only" for="alighaddon3">Align addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="basic-addon3.1">$</span>
                                                    <input type="text" class="form-control" id="alighaddon3" placeholder="Amount">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label for="iconaddon1" class="col-form-label f-w-600">Icon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="sr-only">Icon addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <input type="text" id="iconaddon12" class="form-control" placeholder="Username">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label for="iconaddon3" class="sr-only">Icon addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <span class="input-group-addon" id="icon-addon3.1"><i class="icofont icofont-thumbs-up"></i></span>
                                                    <input type="text" id="iconaddon3" class="form-control" placeholder="Details" aria-describedby="icon-addon3.1">
                                                    <span class="input-group-addon" id="icon-addon3.2"><i class="icofont icofont-thumbs-down"></i></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
                                    <div class="col-lg-6">
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="col-form-label f-w-600">Dropdown</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group" id="dropdown1">
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn btn-danger shadow-none addon-btn waves-effect waves-light dropdown-toggle addon-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Action
                                                        </button>
                                                        <div class="dropdown-menu">
                                                            <a class="dropdown-item" href="#">Action</a>
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="sr-only">Dropdown</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group" id="dropdown2">
                                                    <input type="text" class="form-control" placeholder="Username">
                                                    <div class="input-group-btn">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label class="sr-only">Dropdown addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group" id="dropdown3">
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn btn-success addon-btn shadow-none waves-effect waves-light dropdown-toggle addon-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                                            Action
                                                        </button>
                                                        <div class="dropdown-menu dropdown-menu-right">
                                                            <a class="dropdown-item" href="#">Action</a>
                                                    ...
                                                    <input type="text" class="form-control" placeholder="Username" >
                                                    <div class="input-group-btn">
                                                        <button type="button" class="btn btn-primary addon-btn shadow-none waves-effect waves-light dropdown-toggle addon-btn" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                        ...
                                        <div class="form-group row">
                                            <div class="col-md-2"><label for="btnaddon1" class="col-form-label f-w-600">Button</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <span class="input-group-btn" id="btn-addon1"><button type="submit" class="btn btn-info shadow-none addon-btn waves-effect waves-light">Go!</button></span>
                                                    <input type="text" id="btnaddon1" class="form-control" placeholder="Username" aria-describedby="btn-addon1">
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-2"><label for="btnaddon2" class="sr-only">Button addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <input id="btnaddon2" type="text" class="form-control" placeholder="Username" aria-describedby="btn-addon2">
                                                    <span class="input-group-btn" id="btn-addon2"><button type="submit" class="btn btn-warning shadow-none addon-btn waves-effect waves-light">Go!</button></span>
                                                </div>
                                            </div>
                                        </div>
                                        <div class="form-group row">
                                            <div class="col-md-2"><label for="btnaddon3" class="sr-only">Button addon</label></div>
                                            <div class="col-md-10">
                                                <div class="input-group">
                                                    <span class="input-group-btn" id="btn-addon3.1"><button type="submit" class="btn btn-primary shadow-none addon-btn waves-effect waves-light">Search!</button></span>
                                                    <input id="btnaddon3" type="text" class="form-control" placeholder="Username" aria-describedby="btn-addon3.1">
                                                    <span class="input-group-btn" id="btn-addon3.2"><button type="submit" class="btn btn-success shadow-none addon-btn waves-effect waves-light">Go!</button></span>
                                                </div>
                                            </div>
                                        </div>
                                    </div>
...
<!-- notification -->
<script src="assets/plugins/notification/js/bootstrap-growl.min.js" tppabs="http://ableproadmin.com/light/vertical/assets/plugins/notification/js/bootstrap-growl.min.js"></script>

<!-- syntax highlighter js -->
<script type="text/javascript" src="assets/plugins/highlighter/js/shCore.js" tppabs="http://ableproadmin.com/light/vertical/assets/plugins/highlighter/js/shCore.js"></script>
<script type="text/javascript" src="assets/plugins/highlighter/js/shBrushJScript.js" tppabs="http://ableproadmin.com/light/vertical/assets/plugins/highlighter/js/shBrushJScript.js"></script>
<script type="text/javascript" src="assets/plugins/highlighter/js/shBrushXml.js" tppabs="http://ableproadmin.com/light/vertical/assets/plugins/highlighter/js/shBrushXml.js"></script>
<script type="text/javascript">SyntaxHighlighter.all();</script>

<!-- custom js -->
<script type="text/javascript" src="assets/js/main.js" tppabs="http://ableproadmin.com/light/vertical/assets/js/main.js"></script>
<script type="text/javascript" src="assets/pages/elements.js" tppabs="http://ableproadmin.com/light/vertical/assets/pages/elements.js"></script>
<script src="assets/js/menu.js" tppabs="http://ableproadmin.com/light/vertical/assets/js/menu.js"></script>
