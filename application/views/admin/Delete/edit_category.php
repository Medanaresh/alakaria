        ...
        <div class="modal-body">
            ...
            <form id="insert_sub_admin">
                ...
                <div class="form-group row">
                    ...
                    <label for="example-tel-input" class="col-sm-3 col-form-label form-control-label"> Category Name En</label>

                    <div class="col-sm-9">

                        <input class="form-control" type="text" name="data[category_name]" value="<?php if($value!=NULL){echo $value->category_name;}?>" placeholder="Category Name En">
                 ...
                 <div class="form-group row">
                    ...
                    <label for="example-tel-input" class="col-sm-3 col-form-label form-control-label"> Category Name Ar</label>

                    <div class="col-sm-9">

                        <input class="form-control" type="text" name="data[category_name_ar]" value="<?php if($value!=NULL){echo $value->category_name_ar;}?>" placeholder="Category Name Ar">
