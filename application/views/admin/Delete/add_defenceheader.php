...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Defence Header</h4>
            ...
            <form id="insert_banners">
                ...
                <?php } ?>
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Sub Title_en</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[subtitle_en]" placeholder="Sub Title" value="<?php echo @$value->subtitle_en?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Sub Title_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[subtitle_ar]" placeholder="Sub Title" value="<?php echo @$value->subtitle_ar?>">
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Content_en</label>

                    <div class="col-sm-9">

                    	<textarea class="form-control" name="data[content_en]" id="content_en" placeholder="Content" ><?php echo @$value->content_en?></textarea>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Content_ar</label>

                    <div class="col-sm-9">

                    	<textarea class="form-control" name="data[content_ar]" id="content_ar" placeholder="Description" ><?php echo @$value->content_ar?></textarea>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="defenceheader">
...
$(document).ready(function(){
    ...
    CKEDITOR.replace('data[content_en]');

    CKEDITOR.replace('data[content_ar]');
    ...
    $('.insert_banners').click(function(){     
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
                data.set('data[description_ar]', CKEDITOR.instances['description_ar'].getData());
                  data.set('data[content_en]', CKEDITOR.instances['content_en'].getData());
                data.set('data[content_ar]', CKEDITOR.instances['content_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_defenceheader",
