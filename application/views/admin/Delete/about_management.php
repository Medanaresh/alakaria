                            ...
                            <table id="advanced-table" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td><?php echo $sub->companies; ?></td>

                                        <td><?php echo $sub->new_jobs; ?></td>

                                        <td><?php echo $sub->job_categories; ?></td>

                                        <td><?php echo $sub->total_resumes; ?></td>
...
<script type="text/javascript">
...

    {
...

        {
            ...
            $modal.load('<?php echo site_url('admin/edit_about_management'); ?>', {id: id},
