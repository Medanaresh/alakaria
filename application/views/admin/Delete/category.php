         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <span><button type="button" class="btn btn-success fa fa-plus add_coupons" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;"> Add Category </button></span>
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?php echo $coupon->category_name; ?></td>
                               <td><?php echo $coupon->category_name_ar; ?></td>
                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 ...
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    ...
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       ...
                                       <button type="button" class="btn btn-primary waves-effect waves-light add_coupons" data-toggle="modal"  data-target = "#add_coupons" data-id="<?php echo $coupon->id; ?>"  style="float: none;margin: 5px;">
...
<script type="text/javascript">
...

   {
    ...
    $modal.load('<?php echo site_url('admin/edit_category');?>', {id: id},
