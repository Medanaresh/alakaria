...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Tech Services</h4>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="techServices">
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_techServices",
