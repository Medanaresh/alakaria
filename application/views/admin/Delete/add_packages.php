...
<div class="modal-dialog modal-lg" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center"><?php echo (@$value->id!='')?'Edit':'Add'; ?> Package</h4>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Package Name (AR)</label>
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="text" class="form-control" name="data[package_name_ar]" value="<?//=isset($value->package_name_ar);?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Category</label>
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control" name="data[category]">
                            ...
                            <option value="4" <?php // if(@$value->category == "1"){ echo "selected";} ?>>User</option>
