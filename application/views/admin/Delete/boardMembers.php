...
//print_r($value);
                           ...
                           <tr>
                             ...
                             <td><?php echo $bans->position1_en?></td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_leadership');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_leadership",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"boardMembers"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
