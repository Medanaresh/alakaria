                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?php echo $sn++; ?></td>
   <td><span class="<?php echo $bans->fname; ?>"><?php echo ucfirst($bans->fname); ?></span></td>
   <td><span class="<?php echo $bans->lname; ?>"><?php echo ucfirst($bans->lname); ?></span></td>
<td><span class="<?php echo $bans->email; ?>"><?php echo ucfirst( $bans->email); ?></span></td>
<td><span class="<?php echo $bans->phone; ?>"><?php echo ucfirst($bans->phone); ?></span></td>
<td><span class="<?php echo $bans->expYears; ?>"><?php echo ($bans->expYears)." Years"; ?></span></td>
<td><span class="<?php echo $bans->expMonths; ?>"><?php echo ($bans->expMonths)." Months"; ?></span></td>
<td><span class="<?php echo $bans->address1; ?>"><?php echo ucfirst($bans->expMonths).",".ucfirst($bans->city).", ".ucfirst($bans->state)."-".$bans->postalcode; ?></span></td>
<td><?php
if(!empty($bans->resume))
{
    ?>
    <a href="<?php echo base_url().$bans->resume?>" download="<?php echo $bans->fname?>-Resume">Download</a>
    <?php
}
?>
</td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_partner');?>', {id: id},
