...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Event Header</h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                ...
                $text_ar = array();
                $text_en = array();
                if(!empty($value->list_en))
                {
                    $text_en = explode(",",$value->list_en);
                }
                if(!empty($value->list_ar))
                {
                    $text_ar = explode(",",$value->list_ar);
                }
                ...
                for($i = 0;$i<6;$i++)
                {
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Text_en</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="text_en[]" placeholder="Text" value="<?php echo @$text_en[$i]?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Text_ar</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="text_ar[]" placeholder="Text" value="<?php echo @$text_ar[$i]?>">
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Below Title_en</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[belowtitle_en]" placeholder="Below Title" value="<?php echo @$value->belowtitle_en?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Below Title_ar</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[belowtitle_ar]" placeholder="Below Title" value="<?php echo @$value->belowtitle_ar?>">
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="eventServicesHeader">
   ...
   //             data.set('data[description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_eventServicesHeader",
