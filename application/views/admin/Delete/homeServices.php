         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Services Header</h5>
<?php  if(empty($header_value)){?>
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <?php if(@$header_value){  
                              ...
                              $sn=1; foreach($header_value as $bans)
         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Home Services</h5>
...
<?php echo $bans->title_en?>
      ...
      <td style="*width:30%" >
                              ...
                              <td><span class="<?php echo $status; ?> changes_wstatus"  data-id="<?php echo $bans->id?>" data-status="<?php echo $bans->status?>"><?php echo ucfirst($status1); ?></span></td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_serviceheader');?>', {id: id},
    ...
    $('.who_add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_homeservices');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_homeserviceheader",
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_homeservices",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"home_services_header"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
...
//       alert(status);
       $.ajax({                
             url: "<?php echo base_url();?>admin/update_sp_status",
             type: "POST",
             data: {id:id,status:status,table:"home_services"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
