...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Home Services</h4>
            ...
            <form id="insert_banners">
                ...
                <?php } ?>
                 ...
                 <div class="form-group row validate-file">
                    ...
                    <label style="margin-left: 19px;" for="example-tel-input" class="col-xs-4 col-form-label form-control-label">Background Image</label>

                    <div class="col-sm-8">

                        <input class="form-control" type="file" style="margin-left: 64px;"  name="backgroundimage" onchange="validateimage2()"  id="customFile2">

                    </div>

                </div>

                <?php if(@$value->backgroundimage!=''){ ?>
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <img src="<?php echo base_url().$value->backgroundimage?>" width="100px" height="100px" style="background-color:gray;" >
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="home_services">

                <input type="hidden" name="old_image" value="<?php echo @$value->image; ?>"  />
                <input type="hidden" name="backgroundimage" value="<?php echo @$value->backgroundimage; ?>"  />
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_homeservices",
