         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <span><button type="button" class="btn btn-success fa fa-plus add_coupons" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;"> Add Country </button></span>
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td><?php echo $coupon->country_en; ?></td>
                               <td><?php echo $coupon->country_ar; ?></td>
...
<script type="text/javascript">
...

   {
    ...
    $modal.load('<?php echo site_url('admin/edit_country');?>', {id: id},
