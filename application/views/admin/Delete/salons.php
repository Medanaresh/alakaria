         ...
         <div class="col-sm-12">
            <div class="card">
               ...
               <div class="card-header">
                  <form id="search_data" method="post" action="<?php echo base_url() ?>admin/service_providers">
                     <label>Start Rating Value:</label> <input type="number" id="start_rating_value" name="start_rating_value">
                     <label>End Rating Value:</label>  <input type="number" id="end_rating_value" name="end_rating_value">
                     ...
                     <table id="advanced2-table" class="table  table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                              ...
                              <td>
                                 <a href="<?php echo base_url();?>admin/service_providers_cost/<?php echo  $user->user_id?>" class="btn btn-primary waves-effect waves-light"  style="float: none;margin: 5px;">
                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       ...
                                       <button type="button" class="btn btn-danger waves-effect waves-light delete_driver" data-id="<?php echo $user->user_id; ?>" style="float: none;margin: 5px;">
