                        ...
                        <tbody>
                          ...
                          <?php if(@$value){  
                           ...
                           <tr>
                              ...
                              <td style="width:30%" ><?php echo $bans->name?></td>
                              <td style="width:30%" ><?php echo $bans->address?></td>
                              <td style="width:30%" ><?php echo $bans->city?></td>
                              <td style="width:30%" ><?php echo $bans->state?></td>
                              <td style="width:30%" ><?php echo $bans->pincode?></td>
                              <td style="width:30%" ><?php echo $bans->phone?></td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_donations');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_donations",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"privacyPolicy"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
