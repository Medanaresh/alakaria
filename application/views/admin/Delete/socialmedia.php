...
<th>Social Media Link</th>
                        ...
                        <span ><?php echo ucfirst($bans->title); ?></span> </td>
   ...
   <td>
                              ...
                              <span class="<?php //echo $status; ?> "  data-id="<?php //echo $bans->id?>" data-status="<?php //echo $bans->status?>" style="cursor: pointer"><?php echo $bans->link; ?></span> </td>

                           
                              <td>
                          
                              <span class="<?php echo $status; ?> changes_ustatus"  data-id="<?php echo $bans->id?>" data-status="<?php echo $bans->status?>" style="cursor: pointer"><?php echo ucfirst($status1); ?></span> </td>
