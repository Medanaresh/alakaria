    ...
    <div class="row">
      <div class="col-sm-12">
        <div class="card">
          ...
          <span><button type="button" class="btn btn-success fa fa-plus add_sub_admin" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;/*margin-top:-75px;*/"> Add Labour Office User </button></span>
        </div>
          ...
          <div class="card-block">
            ...
            <table id="advanced-table" class="table table-striped table-bordered nowrap">
              ...
              <tbody>
              <?php 
               $i=1; foreach($labour_office as $sub)
                {
                if($sub->status == "1") 
                {
                ...
                <tr>
                  <td><?php echo $i; ?></td>
                   <td style="width:100px;">
                      <img src="<?php echo base_url().$sub->profile_image?>" height=50px; alt="" >
                  </td>
                  ...
                  <td style="white-space: nowrap; width: 1%;">
                   <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                       <div class="btn-group btn-group-sm" style="float: none;">
                           ...
                           <button type="button" class="btn btn-primary waves-effect waves-light delete_sub_admin" data-id="<?php echo $sub->id; ?>" style="float: none;margin: 5px;">
               ...
               <!-- <td>
              <button type="button" class="add_permissions btn btn-primary waves-effect waves-light" data-id="<?php echo $sub->id;?>" style="float: none;margin: 5px;"><span class="icofont icofont-eye"></span></button>
             </td>-->
                </tr>
              <?php $i++; }?>
              </tbody>
...
$('.add_sub_admin').on('click',function(event)
{
	...
	$modal.load('<?php echo "edit_labour_office_management";?>', {id: id},
	function()
  {	
	$modal.modal('show');
	});
...
//Add permissions
 ...
 var $modal = $('#add_permissions');
    $('.add_permissions').on('click',function(event)
    {  
      var user_id = $(this).data('id');
      //alert(user_id);
      event.stopPropagation();
      $modal.load('<?php echo "add_menu_permissions";?>', {user_id: user_id},
      function()
      {     
        $modal.modal('show');
      });
