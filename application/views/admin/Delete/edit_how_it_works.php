...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Edit How It Works</h4>
        </div>
              ...
              <div class="form-group row validate-file">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <?php if($value!=NULL){?>  <img src="<?php if($value!=NULL){echo base_url().$value->image;}?>" style="height: 100px; width: 100px;"><?php } ?>
                    </div>
                </div>
                <?php } ?>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Title En</label>
                    <div class="col-sm-9">
                         <input type="text" class="form-control" id="name_en" name="data[title_en]"  placeholder="Title En"  value="<?= @$value->title_en ;?>"/>
                    </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Title Ar</label>
                    <div class="col-sm-9">
                         <input type="text" class="form-control" id="name_ar" name="data[title_ar]"  placeholder="Title Ar"  value="<?= @$value->title_ar ;?>"/>
                    </div>
                </div>
                <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Description En</label>
                    <div class="col-sm-9">
                        <textarea name="data[text_en]" id="text_en" rows="4"  class="form-control"><?php echo  @$value->text_en ;?></textarea>
                    </div>
                </div>
                 <div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Description Ar</label>
                    <div class="col-sm-9">
                        <textarea name="data[text_ar]" id="text_ar" rows="4"  class="form-control"><?php echo  @$value->text_ar ;?></textarea>
                    </div>
                </div>
                <div class="form-group row">
                ...
                <input type="hidden" name="table" value="homepage">
    ...
    $('.insert_banners').click(function(){     
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){                
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_how_it_works",
                    type: "POST",
                    data: data,
