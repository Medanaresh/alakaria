         ...
         <div class="col-sm-12">
            <div class="card">
               <div class="card-header">
                  ...
                  <span><button type="button" class="btn btn-success fa fa-plus add_banners" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;"> Add Success Partner </button></span>
               </div>
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                           ...
                           <tr>
                              <td><?php echo $sn++; ?></td>
                              <td style="width:30%" >
                                 <img src="<?php echo "http://maplenestinc.com/sas/".$bans->image;;?>" style="width:25%;background-color:gray;">
                              </td>
  ...
  $(document).ready(function () 
  {
    ...
    $('.add_banners').on('click',function(event){
     ...
     $('.edit_banners').on('click',function(event){
      var id = $(this).data('id');     
      event.stopPropagation();
      $modal2.load('<?php echo site_url('admin/edit_partner');?>', {id: id},
      function(){
      $modal2.modal('show');
      });
    });
