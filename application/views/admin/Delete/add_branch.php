...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Branch</h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Address_en</label>

                    <div class="col-sm-9">

                    	<textarea  class="form-control" name="data[address_en]" placeholder="Address"><?php echo @$value->address_en?></textarea> 
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Address_ar</label>

                    <div class="col-sm-9">

                    	<textarea  class="form-control" name="data[address_ar]" placeholder="Address"><?php echo @$value->address_ar?></textarea> 
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Phone</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control phone" name="data[phone]" placeholder="Phone" value="<?php echo @$value->phone?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Office </label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control phone" name="data[office]" placeholder="Office" value="<?php echo @$value->office?>">
              ...
              <!--  <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Map Code </label>

                    <div class="col-sm-9">

                    	<textarea  class="form-control" name="data[mapembedded]" placeholder="Map"><?php echo @$value->mapembedded?></textarea> 
...
$("#insert_banners").validate({       
			...
			"data[address_en]":"required",
			"data[address_ar]":"required",
				"data[title_en]":"required",
				"data[phone]":"required",
				"data[office]":"required",
				"data[email]":"required",
