...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Who we are</h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                ...
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
   						  	<?php if(strtolower(pathinfo($value->whoweare_image,PATHINFO_EXTENSION)) == 'mp4' || strtolower(pathinfo($value->whoweare_image,PATHINFO_EXTENSION)) == 'mov'){?>
              
						       <video autoplay muted loop2  width="100px" height="100px" style="background-color:gray;">
                              <source src="<?php echo base_url().$value->whoweare_image?>" type="video/mp4">
                              Your browser does not support HTML5 video.
                            </video>
							<?php 						}else{?>
                        <img src="<?php echo base_url().$value->whoweare_image?>" width="100px" height="100px" style="background-color:gray;" >
						<?php }?>
                    </div>
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title_en</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[whoweare_title_en]" placeholder="Title" value="<?php echo @$value->whoweare_title_en?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[whoweare_title_ar]" placeholder="Title" value="<?php echo @$value->whoweare_title_ar?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_en</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[whoweare_description_en]" id="description_en" placeholder="Description" ><?php echo @$value->whoweare_description_en?></textarea>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[whoweare_description_ar]" id="description_ar" placeholder="Description" ><?php echo @$value->whoweare_description_ar?></textarea>
   ...
   <!-- vision data -->
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Status</label>
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control" name="data[mission_status]">

                            <option value="1" <?php  if(@$value->whoweare_status == "1"){ echo "selected";} ?>>Active</option>

                            <option value="0" <?php  if(@$value->whoweare_status == "0"){ echo "selected";} ?>>Inactive</option>
                ...
                <input type="hidden" name="table" value="home_whoweare">

                <input type="hidden" name="old_image" value="<?php echo @$value->whoweare_image; ?>"  />
...
$(document).ready(function(){
    ...
    CKEDITOR.replace('data[whoweare_description_en]');

    CKEDITOR.replace('data[whoweare_description_ar]');
...
$("#insert_banners").validate({       
           ...
           //     "visionimage"               : "required",
				...
				"data[whoweare_title_en]":"required",
			...
			//	"data[description_ar]":"required",
				"data[whoweare_title_ar]":"required",
...
*/
    ...
    $('.insert_banners').click(function(){     
     ...
     data.set('data[whoweare_description_en]', CKEDITOR.instances['description_en'].getData());
                data.set('data[whoweare_description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_abouthomewhoweare",
