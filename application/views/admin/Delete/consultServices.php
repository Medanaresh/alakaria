         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Consulting Services</h5>
...
<th>Description</th>
  ...
  $stringCut = substr( $bans->description_en, 0, 100);
...
<td><?php echo $string; ?></td>
                              <td><span class="<?php echo $status2; ?> changes_ustatus"  data-id="<?php echo $bans->id?>" data-status="<?php echo $bans->status?>"><?php echo ucfirst($status12); ?></span></td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_consultServices');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_consultServices",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"consultServices"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
