...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Social Responsibility </h4>
   ...
   <!-- vision data -->
     ...
     <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Category</label>
                    ...
                    <select name="data[category]" class="form-control">
                        ...
                        <?php if(@$categories)
                        {
                            ...
                            {
                          ?>
                          <option value="<?php echo $catData->id?>"  <?php if($catData->id == $value->category){echo "selected='selected'";}?>><?php echo $catData->category_en?></option>
                          <?php
                            }
                        }
                        ?>
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Post By</label>

                    <div class="col-sm-9">

                    <select name="data[postby]" class="form-control">
                        <option value=''>Select Postby</option>
                        <?php if(@$authors)
                        {
                            foreach($authors as $authorInfo)
                            {
                          ?>
                          <option value="<?php echo $authorInfo->id?>" <?php if($authorInfo->id == $value->postby){echo "selected='selected'";}?>><?php echo $authorInfo->name_en?></option>
                          <?php
                            }
                        }
                        ?>
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Keywords</label>

                    <div class="col-sm-9">

                    	<textarea  class="form-control" name="data[keyword]" placeholder="Keywords"><?php echo @$value->keyword?></textarea>
					<div class="error" style="color:red;font-size:13px">Note: Add keywords seperated by comma for searching</div>
                    </div>
                ...
                <input type="hidden" name="table" value="socialResponsibility">
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_socialResponsibility",
                    type: "POST",
