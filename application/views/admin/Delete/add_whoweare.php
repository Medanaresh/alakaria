...
<div class="modal-dialog" role="document">
	...
	<div class="" style="color:red;width:110%;font-size:14px">Note:-Upload time will be depend on video file size</div>        
                    </div>
...
<input type="hidden" name="yesid" value="<?php echo @$yesid; ?>">
                <input type="hidden" name="table" value="home_whoweare">

                <input type="hidden" name="old_image" value="<?php echo @$value->image; ?>"  />
                       <input type="hidden" name="old_thumbnail_image" value="<?php echo @$value->thumbnail; ?>"  />
   ...
   "data[description_en]"   : {
    ...
    data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_whoweare",
