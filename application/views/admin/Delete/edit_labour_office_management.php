...
<div class="modal-dialog" role="document">
    <div class="modal-content" style="overflow:hidden">
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Labour Office</h4>
        </div>
            ...
            <form id="insert_sub_admin">
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        ...
                        <input type="hidden" name="data[otp_status]" value="1">
                        <input type="hidden" name="data[flag]" value="1">
                    </div>
                </div>
                <?php if($value!=NULL){?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="email" name="data[email]" value="<?php if($value!=NULL){echo $value->email;}?>" placeholder="Email" required readonly="">
                    </div>
                </div>
                <?php } else{?>
                <div class="form-group row">
                    <label for="example-tel-input" class="col-sm-3 col-form-label form-control-label">Email</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="email" name="data[email]" value="<?php if($value!=NULL){echo $value->email;}?>" placeholder="Email" onchange="check_email(this.value)">
                    </div>
                </div>
                <?php }?>
                <?php if($value==NULL){?>
                <div class="form-group row">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="password" name="data[password]" value="<?php echo @$value->password?>" placeholder="Password">
                    </div>
                </div>
                <?php }else{ ?>
				<div class="form-group row">
                    <label for="example-tel-input" class="col-sm-3 col-form-label form-control-label">Password</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="password" name="data[password]" value="<?php echo @$value->password?>" placeholder="Password" id="txtPassportNumber" disabled="disabled">
                    </div>
                </div>
                <?php } ?>
                <div class="form-group row">
         ...
         validator.form();
            if(validator.form() == true){                
             var data = new FormData($('#insert_sub_admin')[0]); 
               ...
               $.ajax({                
                    url: "<?php echo base_url();?>admin/save_labour_office",
                   type: "POST",
                     data: data,
