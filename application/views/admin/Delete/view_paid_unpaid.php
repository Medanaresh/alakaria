                     ...
                     <div class="tab-pane active" id="user_view" role="tabpanel">
                        <div class="row">
                           <div class="row col-md-2">
                              <img class="img-fluid width-100" style="height: 35%;" src="<?php echo base_url();?><?php echo $user_details->profile_pic;?>"  alt="" style="">
                           </div>
                           <div class="col-md-5">
                              <h4>User Details</h4>
                              <table  class="tftable" >
                        ...
                        <br>
                        <?php if($user_details->sp_receipt !=''){ ?>
                        <div class="row">
                           <div class="row col-md-2">
                              <h4>Receipt</h4>
                              <img class="img-fluid width-100" style="height: 50%;" src="<?php echo base_url();?><?php echo $user_details->sp_receipt;?>">
                           </div>
                        </div>
                        <?php } ?>
                     </div>
