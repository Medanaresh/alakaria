...
<div class="content-wrapper">
  ...
  <!--<a href="<?php echo base_url()?>admin/add_address_form"><button class="btn btn-primary waves-effect waves-light pull-right add_product_category1" style="margin-left:65%">Add contact map</button></a>--></span>

                  <span><button type="button" class="btn btn-success fa fa-plus add_banners" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;"> Add </button></span></div>
...
//print_r($value);
                         ...
                         <td><?php echo $bans->title; ?></td>
                             <td style="width:30%"><img src="<?php echo base_url().$bans->image;?>" style="width:25%;background-color:gray;">  </td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_support');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_support",
