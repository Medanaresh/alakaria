...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Terms & Conditions </h4>
...
<!--
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="termsConditions">
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
          ...
          // alert("****in submit")
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_termsConditions",
