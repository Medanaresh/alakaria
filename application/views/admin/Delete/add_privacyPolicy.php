...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Privacy Policy </h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                ...
                <input type="hidden" name="table" value="privacyPolicy">
     ...
     data.set('data[description]', CKEDITOR.instances['description'].getData());
          ...
          // alert("****in submit")
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_privacyPolicy",
