                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       <button type="button" class="btn btn-primary waves-effect waves-light edit_banners" data-id="<?php echo $row->id; ?>" style="float: none;margin: 5px;">
                                       <span class="icofont icofont-ui-edit"></span>
                                       </button>
                                       <button type="button" class="btn btn-danger waves-effect waves-light  delete_banners" data-id="<?=@$row->id; ?>" style="float: none;margin: 5px;">
  ...
  $(document).ready(function () 
  {
    ...
    $('.add_banners').on('click',function(event){
     ...
     $('.edit_banners').on('click',function(event){
      var id = $(this).data('id');     
      event.stopPropagation();
      $modal2.load('<?php echo site_url('admin/newsletter_reply');?>', {id: id},
      function(){
      $modal2.modal('show');
      });
    });
