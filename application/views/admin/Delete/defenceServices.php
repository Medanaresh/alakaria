                  ...
                  <div class="data_table_main table-responsive">
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap">
                        ...
                        <tbody>
                            ...
                            <?php if(@$defenceHeader){  

                              $sn=1; foreach($defenceHeader as $bans)
         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Defence Services</h5>
...
<th>Title</th>
                        ...
                        <tbody>
                          ...
                          <?php if(@$defenceService){  

                              $sn=1; foreach($defenceService as $bans)
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_defenceheader');?>', {id: id},
    ...
    */
      ...
      $modal.load('<?php echo site_url('admin/add_defenceservice');?>', {id:id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_defenceheader",
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_defenceServices",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"defenceheader"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
...
//       alert(status);
       $.ajax({                
             url: "<?php echo base_url();?>admin/update_sp_status",
             type: "POST",
             data: {id:id,status:status,table:"defenceServices"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
