      ...
      <div class="col-sm-12">
        <div class="card">
          <div class="card-header"><h5 class="card-header-text"><?=@$page['title']?></h5>
            <span>
            <button class="btn btn-primary waves-effect waves-light pull-right insert_category" data-name="<?php echo @$current_page; ?>" style="margin-left:65%">Add Category</button></span>
          </div>
              ...
              <tbody>
                   <?php 
                      ...
                      <tr id="hide<?php echo $cats->cat_id;?>">
                        ...
                        <td><?php echo $cats->category_en; ?></td>
                        <td><?php echo $cats->category_ar; ?></td>                           
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"categories"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
