                            ...
                            <table id="advanced-table" class="table table-striped table-bordered nowrap">
                                ...
                                <tbody>
                                    ...
                                    foreach ($labour_process as $sub) {
                                          if ($sub->labour_company_status == "2") {
                                            $statusp = "tag tag-success";
                                            $statusp1 = 'Rejected Interview ';
                                        } else if ($sub->labour_company_status == "5"){
                                            $statusp = "tag tag-default";
                                            $statusp1 = 'Rejected Offline';
                                        } else if ($sub->labour_company_status == "8"){
											 $statusp = "badge badge-success";
                                            $statusp1 = 'Rejected Online';
