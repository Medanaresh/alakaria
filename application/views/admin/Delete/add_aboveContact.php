...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Above Contact</h4>
            ...
            <form id="insert_banners">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_en</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[content_en]" id="description_en" placeholder="Description" ><?php echo @$value->content_en?></textarea>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[content_ar]" id="description_ar" placeholder="Description" ><?php echo @$value->content_ar?></textarea>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="home_focus">
...
*/
    ...
    $('.insert_banners').click(function(){     
     ...
     data.set('data[content_en]', CKEDITOR.instances['description_en'].getData());
                data.set('data[content_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_aboveContact",
