...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Home Contact</h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                ...
                <div class="form-group row validate-file">
                    ...
                    <label style="margin-left: 19px;" for="example-tel-input" class="col-xs-5 col-form-label form-control-label">Background Image</label>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="home_contact">
    ...
    //            data.set('data[mission_description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_homeContact",
