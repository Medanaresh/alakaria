            ...
            <div class="col-sm-12">
                <div class="card">
                    <div class="card-header"><h5 class="card-header-text"><?php echo @$page['title']; ?></h5>
                        <span><button type="button" class="btn btn-success fa fa-plus add_sub_admin" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;/*margin-top:-75px;*/"> Add Testimonials </button></span>
                    </div>
                                ...
                                <tbody>
                                    ...
                                    foreach ($testimonials as $sub) {
                                        ...
                                        <tr>
                                            ...
                                            <td><?php echo $sub->designation; ?></td>
...
<script type="text/javascript">
    $(document).ready(function ()
    {
        ...
        $('.add_sub_admin').on('click', function (event)
        {
            ...
            $modal.load('<?php echo "add_testimonials"; ?>', {id: id},
                    function ()
                    {
                        $modal.modal('show');
                    });
