...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Vision</h4>
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title_en</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[vision_title_en]" placeholder="Title" value="<?php echo @$value->vision_title_en?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[vision_title_ar]" placeholder="Title" value="<?php echo @$value->vision_title_ar?>">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_en</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[description_en]" id="description_en" placeholder="Description" ><?php echo @$value->vision_description_en?></textarea>
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description_ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<textarea class="form-control" name="data[description_ar]" id="description_ar" placeholder="Description" ><?php echo @$value->vision_description_ar?></textarea>
   ...
   <!-- vision data -->
                ...
                <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Status</label>
                    ...
                    <div class="col-sm-9">
                        ...
                        <select class="form-control" name="data[vision_status]">

                            <option value="1" <?php  if(@$value->vision_status == "1"){ echo "selected";} ?>>Active</option>

                            <option value="0" <?php  if(@$value->vision_status == "0"){ echo "selected";} ?>>Inactive</option>
                ...
                <input type="hidden" name="old_image" value="<?php echo @$value->vision_image; ?>"  />
...
*/
    ...
    $('.insert_banners').click(function(){     
     ...
     data.set('data[vision_description_en]', CKEDITOR.instances['description_en'].getData());
                data.set('data[vision_description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_aboutvision",
