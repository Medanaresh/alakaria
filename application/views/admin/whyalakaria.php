      ...
      <div class="row">
         ...
         <div class="main-header">
            ...
            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
               ...
               <li class="breadcrumb-item"><a href="">WHY AL AKARIA</a>
         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">WHY AL AKARIA CONTENT</h5>
         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">WHY AL AKARIA ICONS</h5>
<?php  if(empty($value2)){?>
...
<script type="text/javascript">
...

  {
    ...
    $('.vision_add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_whyalakaria_content');?>', {id: id},
