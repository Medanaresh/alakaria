...
<div class="form-group row">    
                ...
                <div class="col-sm-9">             
                <input type="text" name="data[link]" value="<?php echo @$value->link?>" class="form-control" placeholder="link"/>
                </div>               
                </div>
                ...
                <input type="hidden" name="table" value="quicklinks">
    ...
    $('.insert_banners').click(function(){     
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){ 
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_quicklinks",
                    type: "POST",
                    data: data,
