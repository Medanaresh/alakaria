         ...
         <div class="col-sm-12">
            ...
            <div class="card mb-3">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">OUR SERVICES CONTENT</h5>

<?php  if(empty($value1)){?>

                  <span><button type="button" class="btn btn-success fa fa-plus mission_add_banners" data-name="<?php echo @$current_page; ?>" > Add </button></span>
<?php } ?>
               </div>
         ...
         <div class="col-sm-12">
            ...
            <div class="card mb-3">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Services</h5>
<?php  //if(empty($value2)){?>
         ...
         <div class="col-sm-12">
            ...
            <div class="card mb-3">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Mission and Vision</h5>
<?php  if(empty($value3)){?>
...
<th>Vision Image</th>
                	...
                	<?php if(strtolower(pathinfo($bans->mission_image,PATHINFO_EXTENSION)) == 'mp4' || strtolower(pathinfo($bans->mission_image,PATHINFO_EXTENSION)) == 'mov'){?>
                									  <video autoplay muted loop2  style="width:25%;background-color:gray;" >
                                              <source src="<?php echo base_url().$bans->mission_image?>" type="video/mp4">
                                              Your browser does not support HTML5 video.
                                            </video>
                									<?php }else{?>
                                                 <img src="<?php echo base_url().$bans->mission_image;;?>" style="width:25%;background-color:gray;">
                								<?php }?>
                	...
                	<?php if(strtolower(pathinfo($bans->vision_image,PATHINFO_EXTENSION)) == 'mp4' || strtolower(pathinfo($bans->vision_image,PATHINFO_EXTENSION)) == 'mov'){?>
                									  <video autoplay muted loop2  style="width:25%;background-color:gray;" >
                                              <source src="<?php echo base_url().$bans->vision_image?>" type="video/mp4">
                                              Your browser does not support HTML5 video.
                                            </video>
                									<?php }else{?>
                                                 <img src="<?php echo base_url().$bans->vision_image;;?>" style="width:25%;background-color:gray;">
                								<?php }?>
         ...
         <div class="col-sm-12">
            ...
            <div class="card mb-3">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Awards Content</h5>
<?php  if(empty($value4)){?>

                  <span><button type="button" class="btn btn-success fa fa-plus awards_add_banners" data-name="<?php echo @$current_page; ?>" > Add </button></span>
<?php }?>
                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 ...
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    ...
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       ...
                                       <button type="button" class="btn btn-primary waves-effect waves-light awards_add_banners" data-toggle="modal"  data-target = "#add_banners" data-id="<?php echo $bans->id; ?>"  style="float: none;margin: 5px;">
         ...
         <div class="col-sm-12">
            ...
            <div class="card mb-3">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text">Awards List</h5>
<?php  //if(empty($value5)){?>
                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 ...
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    ...
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       ...
                                       <button type="button" class="btn btn-primary waves-effect waves-light awards_list_add_banners" data-toggle="modal"  data-target = "#add_banners" data-id="<?php echo $bans->id; ?>"  style="float: none;margin: 5px;">
...
$('.awards_list_add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/awards');?>', {id:id},
...
$('.mission_vision_add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_mission_vision');?>', {id: <?php echo $id?>},
      ...
      $modal.load('<?php echo site_url('admin/add_service_content');?>', {id: <?php echo $id?>},
