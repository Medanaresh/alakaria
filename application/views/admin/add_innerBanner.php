...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Inner Page Banner</h4>
        ...
        <div class="modal-body">
            ...
            <form id="insert_banners">
                 ...
                 <div class="form-group row validate-file">
                    ...
                    <label style="margin-left: 19px;" for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Banner</label>

                    <div class="col-sm-9">

                        <input class="form-control" type="file" style="margin-left: 64px;"  name="image" onchange="validateimage()"  id="customFile">
<p style="color:red;text-align:right;"> Note: Banner dimension (1921 X 1074 pixels)</p>
                 ...
                 <div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title En</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text" class="form-control" name="data[title_en]"  required placeholder="" value="<?php echo @$value->title_en?>" />
...
<div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Title Ar</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text" class="form-control" name="data[title_ar]"  required placeholder="" value="<?php echo @$value->title_ar?>" />
                ...
                <input type="hidden" name="table" value="innerBanners">
 ...
 //data.set('data[description_en]', CKEDITOR.instances['d1'].getData());
               // data.set('data[description_ar]', CKEDITOR.instances['d2'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_innerBanner",
...
<script type="text/javascript">
   ...
   function validateimage(){
       ...
       if(ext == "jpeg" || ext == "jpg" || ext == "png"|| ext == "PNG" || ext == "JPG" || ext == "JPEG" || ext == "mp4"|| ext == "svg")
