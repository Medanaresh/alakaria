<div class="content-wrapper">
   ...
   <div class="container-fluid">
      ...
      <!--<form method="post" action="<?php echo base_url('admin/export_weekly_report'); ?>">
...
<?php }?>
               ...
               <div class="card-block">
                  ...
                  <div class="data_table_main table-responsive">
                     ...
                     <table id="advanced-table" class="table table-striped table-bordered nowrap advanced-table">
                        ...
                        <tbody>
                          ...
                          <?php if(@$value){  
                           ...
                           <tr>
                              ...
                              <td><?php echo $sn++; ?></td>
<td><img src="<?php echo base_url('').$bans->image; ?>" width="50px;" height="50px;"></td>
                 <td style="width:30%"><?php echo $bans->email?></td>

<td style="width:30%"><?php echo $bans->mobile?></td>


 <!--<td>
<span class="<?php echo $status2; ?> changes_mstatus"  data-id="<?php echo $bans->id?>" data-status="<?php echo $bans->status?>"><?php echo ucfirst($status12); ?></span>
</td>-->
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_footer');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_footer",
...
//       alert(status);
       $.ajax({                
             ...
             type: "POST",
             data: {id:id,status:status,table:"termsConditions"},
             error:function(request,response){
                 console.log(request);
             },                  
             success: function(result){
