...
<span><button type="button" class="btn btn-success  add_banners" data-name="<?php echo @$current_page; ?>" style="margin-left:75%;"> Add </button></span>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_quicklinks');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_quicklinks",
