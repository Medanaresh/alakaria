   ...
   <div class="container-fluid">
      ...
      <div class="row">
         ...
         <div class="main-header">
            ...
            <h4><?php echo $projectname[$proj]; ?></h4>
            ...
            <ol class="breadcrumb breadcrumb-title breadcrumb-arrow">
               ...
               <li class="breadcrumb-item"><a href=""><?php echo $projectname[$proj]; ?></a>
         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <h5 class="card-header-text"><?php echo $projectname[$proj]; ?></h5>
...
//print_r($value);
                           ...
                           <tr>
                              ...
                              <td><?php echo $sn++; ?></td>
<!--<td><?php echo $projectname[$bans->project_id]; ?></td>-->
