...
<div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Count</label>

                    <div class="col-sm-9">

                    	<input type="text"  class="form-control" name="data[count]" placeholder="Count" value="<?php echo @$value->count?>">						
                    </div>
                ...
                <!--<div class="form-group row">
                  ...
                  <label class="col-sm-3 col-form-label form-control-label">Description</label>
                    ...
                    <div class="col-sm-9">
                    	...
                    	<input type="text"  class="form-control" name="data[description]" placeholder="Description" value="<?php echo @$value->description?>">
                ...
                <input type="hidden" name="table" value="bannerdata">
    ...
    //            data.set('data[mission_description_ar]', CKEDITOR.instances['description_ar'].getData());
            ...
            //    data.set('data[vision_description_ar]', CKEDITOR.instances['vision_description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_bannerdata",
