...
<div class="form-group row">    
                <label class="col-sm-3 col-form-label form-control-label">Social Media</label>     
                <div class="col-sm-9">             
                <select name="data[type]" class="form-control" required>
                <option value="">---Select---</option>
                <option value="1"<?php if($value->type == 1) { echo "selected"; } ?>>Facebook</option>
                <option value="2"<?php if($value->type == 2) { echo "selected"; } ?>>Twitter</option>
                <option value="3"<?php if($value->type == 3) { echo "selected"; } ?>>Google</option>
                <option value="4"<?php if($value->type == 4) { echo "selected"; } ?>>Youtube</option>
                <option value="5"<?php if($value->type == 5) { echo "selected"; } ?>>Instagram</option>
                </select>
                </div>               
                </div>
