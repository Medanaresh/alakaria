               ...
               <div class="card-block">
                ...
                <form id="insert_address" method="post" action="<?php echo base_url();?>admin/save_map">
                                ...
                                <div class="form-group row">
                                    ...
                                    <label for="example-datetime-local-input" class="col-sm-2 col-form-label form-control-label">Location</label>
                                ...
                                <div class="form-group row">
                                  ...
                                  <label for="example-datetime-local-input" class="col-sm-2 col-form-label form-control-label">Latitude</label>
                                  ...
                                  <div class="col-sm-4">
                                   ...
                                   <div class="d-flex align-items-center">
                                      ...
                                      <input type="text" name="data[latitude]" value="<?php echo @$map['latitude'];?>" id="latitude" class="form-control" placeholder="latitude" >
                                        ...
                                        <label for="latitude" class="field-icon p-2">
                              ...
                              <label for="example-datetime-local-input" class="col-sm-2 col-form-label form-control-label">Longitude</label>
                                ...
                                <div class="col-sm-4">
                                   ...
                                   <div class="d-flex align-items-center">
                                       ...
                                       <input type="text" name="data[longitude]" value="<?php echo @$map['longitude'];?>" id="longitude" class="form-control" placeholder="longitude">
                                        ...
                                        <label for="longitude" class="field-icon p-2">
                                ...
                                <div class="form-group row">
                                     ...
                                     <div class="section row w-100">
                                      ...
                                      <div id="dealer_map" style="height:400px; width: 100%; border: 2px solid ;"></div>
