         ...
         <div class="col-sm-12">
            <div class="card">
               <div class="card-header d-flex align-items-center">
                  ...
                  <span class="float-right ml-auto"><button type="button" class="btn btn-success add_banners" data-name="<?php echo @$current_page; ?>"><i class="fa fa-plus pr-1"></i> Add Banners </button></span>
               </div>
                              ...
                              <td style="white-space: nowrap; width: 1%;">
                                 <div class=" user-toolbar btn-toolbar" style="text-align: left;">
                                    <div class="btn-group btn-group-sm" style="float: none;">
                                       <button type="button" class="btn btn-primary waves-effect waves-light add_banners" data-id="<?php echo $bans->id; ?>" style="float: none;margin: 5px;">
...
/*     $('.edit_banners').on('click',function(event){
      var id = $(this).data('id');     
      event.stopPropagation();
      $modal2.load('<?php echo site_url('admin/edit_banners');?>', {id: id},
      function(){
      $modal2.modal('show');
      });
    });*/
