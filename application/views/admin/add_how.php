...
-->
                ...
                <div class="col-sm-9">             
                <input type="text" name="data[title]" value="<?php echo @$value->title?>" class="form-control" placeholder="Title En"/>
                </div>               
                </div>
 ...
 <div class="form-group row">    
                ...
                <input type="hidden" name="table" value="how">
    ...
    $('.insert_banners').click(function(){     
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){ 
                ...
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_how",
                    type: "POST",
                    data: data,
