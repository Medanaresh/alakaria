...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Title En</label>
                    <div class="col-sm-9">
                    	<input type="text" class="form-control" name="data[title_en]" id="title_en" placeholder="title en" value="<?php echo @$value->title_en?>">
                    </div>
                </div>
...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Title Ar</label>
                    <div class="col-sm-9">
                    	<input type="text" class="form-control" name="data[title_ar]" id="title_ar" placeholder="title ar" value="<?php echo @$value->title_ar?>">
                    </div>
                </div>
...
<div class="form-group row">
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="awards_content">
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
     ...
     data.set('data[description_ar]', CKEDITOR.instances['description_ar'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_awards_content",
