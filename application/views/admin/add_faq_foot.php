...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Button En</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[button_en]" placeholder="Button En" value="<?php echo @$value->button_en?>">
                       </div>
                 </div>
...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Button Ar</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[button_ar]" placeholder="Button Ar" value="<?php echo @$value->button_ar?>">
                       </div>
                 </div>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="faq_foot">
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_faq_foot",
