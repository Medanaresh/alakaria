         ...
         <div class="col-sm-12">
            ...
            <div class="card">
               ...
               <div class="card-header">
                  ...
                  <!--<span>
<a href="<?php echo base_url('admin/add_media'); ?>">
<button type="button" class="btn btn-success" data-name="<?php echo @$current_page; ?>"><i class="fa fa-plus pr-1"></i> Add </button>
</a>
</span>
<br><br>-->
...
<!--<a href="<?php echo base_url('admin/edit_media'); ?>/<?php echo $bans->id; ?>">
...
<script type="text/javascript">
...

  {
    ...
    /*$('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_messagetypes');?>', {id: id},
...
//$('.add_banners').on('click',function(event){
    $("body").on("click", ".add_banners", function(event){ 
      ...
      $modal.load('<?php echo site_url('admin/addaddmedia');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_media",
