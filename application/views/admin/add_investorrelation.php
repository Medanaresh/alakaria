...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Enquiry Title En</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[enquiry_title_en]" placeholder="Enquiry Title En" value="<?php echo @$value->enquiry_title_en?>">
                       </div>
                 </div>


<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Enquiry Title Ar</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[enquiry_title_ar]" placeholder="Enquiry Title Ar" value="<?php echo @$value->enquiry_title_ar?>">
                       </div>
                 </div>

<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Enquiry Description En</label>
                    <div class="col-sm-9">
                    	<textarea class="form-control" name="data[enquiry_desc_en]" id="enquiry_desc_en" placeholder="Enquiry Description En" ><?php echo @$value->enquiry_desc_en?></textarea>
                    </div>
                </div>

                
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Enquiry Description Ar</label>
                    <div class="col-sm-9">
                    	<textarea class="form-control" name="data[enquiry_desc_ar]" id="enquiry_desc_ar" placeholder="Enquiry Description Ar" ><?php echo @$value->enquiry_desc_ar?></textarea>
                    </div>
                </div>
   ...
   <!-- vision data -->
                ...
                <input type="hidden" name="table" value="investorrelation">
...
CKEDITOR.replace('data[enquiry_desc_en]');



    CKEDITOR.replace('data[enquiry_desc_ar]');
...
"data[enquiry_desc_en]":"required",
"data[enquiry_desc_ar]":"required",
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
               ...
               data.set('data[description_ar]', CKEDITOR.instances['description_ar'].getData());
                ...
                data.set('data[enquiry_desc_en]', CKEDITOR.instances['enquiry_desc_en'].getData());

                data.set('data[enquiry_desc_ar]', CKEDITOR.instances['enquiry_desc_ar'].getData());
