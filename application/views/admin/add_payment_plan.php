...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Payment Plan</h4>
...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Sub Title En</label>
                    <div class="col-sm-9">
                             <textarea  class="form-control" rows="3" name="data[subtitle_en]" placeholder="Sub Title En"><?php echo @$value->subtitle_en?></textarea>                        
</div>
                 </div>
...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Sub Title Ar</label>
                    <div class="col-sm-9">
                             <textarea  class="form-control" rows="3" name="data[subtitle_ar]" placeholder="Sub Title Ar"><?php echo @$value->subtitle_ar?></textarea>                        
</div>
                 </div>
...
<input type="hidden" name="id" value="<?php echo $value->id; ?>">
                <input type="hidden" name="table" value="payment_plan">
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
     ...
     data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_payment_plan",
