...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Year</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[year]" placeholder="Year" value="<?php echo @$value->year?>">
                       </div>
                 </div>
...
<div class="form-group row validate-file">
                    ...
                    <div class="col-sm-9">
                        <input class="form-control" type="file" style="margin-left: 64px;"  name="pdf" onchange="validateimage2()"  id="customFile2">
                    </div>
                </div>
...
<input type="hidden" name="id" value="<?php echo $value->id; ?>">
                <input type="hidden" name="table" value="annual_report">
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_finance",
