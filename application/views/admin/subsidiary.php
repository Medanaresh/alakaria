...
<td><?php echo $bans->link; ?></td>


                             <td><img src="<?php echo base_url().$bans->image;?>" height="75px;" width="75px;" background-color:gray;">  </td>
    <td><?php echo $bans->position; ?></td>
...
<a href="<?php echo base_url(''); ?>admin/subsidiarymap/<?php echo $bans->id; ?>" target="_blank">
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_subsidiary');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_subsidiary",
