...
<td><?php echo $bans->country_code.$bans->mobile; ?>
</td><td><?php echo $bans->email; ?>
</td><td><?php echo $bans->country; ?>
</td><td><?php echo $bans->message; ?></td>
<td><?php echo $bans->comments; ?></td>
...
<script type="text/javascript">
...

  {
    ...
    $('.add_banners').on('click',function(event){
      ...
      $modal.load('<?php echo site_url('admin/add_contact_request2');?>', {id: id},
       ...
       swal({
          ...
          function(){
            ...
            $.ajax({                
             ...
             url: "<?php echo base_url();?>admin/delete_messagetypes",
