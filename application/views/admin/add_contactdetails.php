...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Mobile</label>
                    <div class="col-sm-9">
                         <input type="text" class="form-control" id="mobile" name="data[mobile]"  placeholder="Mobile"  value="<?php echo $value->mobile?>"/>
                    </div>
                </div>
...
<div class="form-group row">
                ...
                <input type="hidden" name="table" value="contactdetails">
        ...
        var validator = $("#insert_banners").validate();       
            ...
            if(validator.form() == true){ 
               ...
               data.set('data[description_ar]', CKEDITOR.instances['description_ar'].getData());
                $.ajax({                
                    url: "<?php echo base_url();?>admin/save_contactdetails",
                    type: "POST",
                    data: data,
