...
<div class="modal-dialog" role="document">
    ...
    <div class="modal-content" style="overflow:hidden">
        ...
        <div class="modal-header" style="border-bottom-color: #ccc;">
            ...
            <h4 class="modal-title" align="center">Add / Edit Brochure</h4>
...
<div class="form-group row validate-file">
                    <label style="margin-left: 19px;" for="example-tel-input" class="col-xs-3 col-form-label form-control-label">Thumbnail</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="file" style="margin-left: 64px;"  name="thumbnail" onchange="validateimage()"  id="customFile">
 
<p style="color:red;text-align:right;"> Note: Image dimension (726 X 511 pixels)</p>
...
<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Brochure Title En</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[brochure_title_en]" placeholder="Brochure Title En" value="<?php echo @$value->brochure_title_en?>">                        
</div>
                 </div>

<div class="form-group row">
                  <label class="col-sm-3 col-form-label form-control-label">Brochure Title Ar</label>
                    <div class="col-sm-9">
                             <input type="text"  class="form-control" name="data[brochure_title_ar]" placeholder="Brochure Title Ar" value="<?php echo @$value->brochure_title_ar?>">                        
</div>
                 </div>
...
<div class="form-group row validate-file">
                    <label style="margin-left: 19px;" for="example-tel-input" class="col-xs-3 col-form-label form-control-label">PDF</label>
                    <div class="col-sm-9">
                        <input class="form-control" type="file" style="margin-left: 64px;"  name="pdf" onchange="validateimage()"  id="customFile">
...
<div class="form-group row">
                    <label class="col-sm-3 col-form-label form-control-label"></label>
                    <div class="col-sm-9">
                        <a href="<?php echo base_url('').$value->pdf; ?>" target="_blank">Download PDF</a>
                    </div>
                </div>
...
<input type="hidden" name="id" value="<?php echo $value->id; ?>">
                <input type="hidden" name="table" value="overview">
...
<input type="hidden" name="old_pdf" value="<?php echo @$value->pdf; ?>"  />
...
$('.forgot_form').html("<i class='fa fa-spinner fa-spin'></i>");
     ...
     //data.set('data[description_en]', CKEDITOR.instances['description_en'].getData());
                ...
                $.ajax({                
                    ...
                    url: "<?php echo base_url();?>admin/save_overview",
