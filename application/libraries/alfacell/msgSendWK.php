...
$sender = "NEW SMS";					//The sender name that will be shown when the message is delivered
...
$msgKey = "(1),*,Muhammad,@,(2),*,10/30/2022***(1),*,Ahmad,@,(2),*,12/30/2022";

										/*	Countervailing values, the following are the symbols details
...
$resultType = 1;						//Determine the send time, 0 means send now
...
/*
// Send templates messages using apiKey
echo sendSMSWK($apiKey, "", $numbers, $sender, $msg, $msgKey, $MsgID, $timeSend, $dateSend, $deleteKey, $resultType);
*/
?>